...
export function scheduleUploadCleanup(id) {
...
export function detectMimeFromMagic(buffer, fileName = "") {
...
export function normalizeUploadMime(fileName = "", declaredType = "", detectedType = "") {
  const ext = getFileExtension(fileName)
...
export function isAllowedUploadByAccept(fileName = "", mimeType = "") {
  const ext = getFileExtension(fileName)
...
export function isMimeCompatibleWithExtension(fileName = "", mimeType = "") {
  const ext = getFileExtension(fileName)
  const normalizedMime = String(mimeType || "").toLowerCase()
...
export function buildFailedExtraction(kind = "document", method = "unknown", warning = "") {
  return {
    text: "",
    fullTextLength: 0,
    kind,
...
export function buildTextPreview(text = "", limit = uploadTextLimit) {
...
export function finalizeTextExtraction(rawText = "", options = {}) {
...
export function formatExtractionQualityLabel(quality = "") {
...
export function buildUploadExtractionBlock(uploadEntry, extraction) {
