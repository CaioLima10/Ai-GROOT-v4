-- GROOT VECTOR DATABASE - PARTE 4 (TRIGGERS E DADOS) - CORRIGIDO
...
-- 12. Triggers para atualizar timestamp (versão sem IF NOT EXISTS)
-- Se der erro de "already exists", ignore e continue

-- Triggers para knowledge_embeddings
