---
title: GIOM Study Document 085 - Church fathers and patristics
source: https://internal.local/giom/private-library-pack/document-085
license: internal
...
## Practice prompts
- Explain patristics for a beginner and then for an advanced learner.
