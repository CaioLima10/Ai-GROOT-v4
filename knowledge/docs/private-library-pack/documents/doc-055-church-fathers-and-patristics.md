---
title: GIOM Study Document 055 - Church fathers and patristics
source: https://internal.local/giom/private-library-pack/document-055
license: internal
...
## Practice prompts
- Explain early church for a beginner and then for an advanced learner.
