---
title: GIOM Study Document 043 - Christian thinkers and their books
source: https://internal.local/giom/private-library-pack/document-043
license: internal
...
## Practice prompts
- Explain ideas for a beginner and then for an advanced learner.
