---
title: GIOM Study Document 003 - Protestant books, theologians and authors
source: https://internal.local/giom/private-library-pack/document-003
license: internal
category: private_library
categories: private_library, protestant, books, theology, church_history
modules: research, language_learning, theological_studies
updatedAt: 2026-03-30
---

# Protestant books, theologians and authors

## Core objective
Build fluent comprehension, interpretation and conversation quality for the GIOM assistant in the domain of Protestant books, theologians and authors.

## Key vocabulary
- Focus term: doctrine
- Domain tags: protestant, books, theology, church_history
...
## Practice prompts
- Explain doctrine for a beginner and then for an advanced learner.
