---
title: GIOM Study Document 100 - Church fathers and patristics
source: https://internal.local/giom/private-library-pack/document-100
license: internal
...
## Practice prompts
- Explain church father for a beginner and then for an advanced learner.
